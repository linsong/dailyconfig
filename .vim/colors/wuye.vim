...
hi MoreMsg	gui=BOLD guifg=#43CD80 guibg=bg		cterm=BOLD ctermfg=darkcyan ctermbg=black
hi ModeMsg	gui=NONE guifg=#90EE90 guibg=#00688B	cterm=NONE ctermfg=yellow ctermbg=darkcyan
hi LineNr	gui=underline guifg=#607B8B guibg=#121212	cterm=underline ctermfg=darkgrey ctermbg=black
hi Question	gui=BOLD guifg=#4EEE94 guibg=bg		cterm=BOLD ctermfg=darkcyan ctermbg=black
...
hi Visual	gui=reverse guibg=#FFD700 guifg=#191970	cterm=reverse ctermbg=yellow ctermfg=blue
...
hi CursorIM	gui=NONE guifg=fg guibg=#00FF00		cterm=NONE ctermfg=black ctermbg=green
...
hi Identifier	gui=NONE guifg=#00BFFF guibg=bg		cterm=NONE ctermfg=lightcyan ctermbg=black
	hi Function	gui=NONE guifg=#00FFFF guibg=bg		cterm=NONE ctermfg=lightcyan ctermbg=black
hi Statement	gui=NONE guifg=#54FF9F guibg=bg		cterm=NONE ctermfg=lightgreen ctermbg=black
	...
	hi Keyword	gui=NONE guifg=#ADFF2F guibg=bg		cterm=NONE ctermfg=lightgreen ctermbg=black
	hi Exception	gui=NONE guifg=#90EE90 guibg=bg		cterm=NONE ctermfg=lightgreen ctermbg=black
hi PreProc	gui=NONE guifg=#8470FF guibg=bg		cterm=NONE ctermfg=lightmagenta ctermbg=black
...
hi Special	gui=NONE guifg=#E0B880 guibg=bg		cterm=NONE ctermfg=yellow ctermbg=black
	hi Specialchar	gui=NONE guifg=#E0B880 guibg=bg		cterm=NONE ctermfg=yellow ctermbg=black
	hi Tag		gui=NONE guifg=#D2691E guibg=bg		cterm=NONE ctermfg=yellow ctermbg=black
	hi Delimiter	gui=NONE guifg=#E0B880 guibg=bg		cterm=NONE ctermfg=yellow ctermbg=black
...
hi Todo		gui=NONE guifg=#191970 guibg=#E6E620	cterm=BOLD ctermfg=darkblue ctermbg=yellow
