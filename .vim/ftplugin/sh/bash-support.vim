...
"          
let s:root_dir  	= $HOME.'/.vim/ide_support/bash'
"
...
let s:BASH_Project                 = ""
"
let s:BASH_CodeSnippets            = s:root_dir."codesnippets/"
...
let s:BASH_Template_Directory      = s:root_dir."templates/"
...
let s:BASH_Wrapper                 = s:root_dir.'scripts/wrapper.sh'
"
"
"------------------------------------------------------------------------------
