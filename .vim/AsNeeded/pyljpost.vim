...
:command! -nargs=* LJPost call LJPost(<f-args>)
:command! -nargs=* LJTemplate call LJTemplate(<f-args>)
:command! -nargs=* LJUserPassword call LJUserPassword(<f-args>)
